...
// ---------- WorldScript ----------
class IT_Customs_UpdaterWS : public WorldScript
{
public:
    IT_Customs_UpdaterWS()
        : WorldScript("IT_Customs_UpdaterWS", std::vector<uint16>{ WORLDHOOK_ON_AFTER_CONFIG_LOAD, WORLDHOOK_ON_STARTUP }) {}
    ...
    void OnStartup() override
    {
        ...
        LOG_INFO("gv.customs", "┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓");
        LOG_INFO("gv.customs", "┃ Instance Tools – Customs SQL Updater (auto)         ┃");
        LOG_INFO("gv.customs", "┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛");
